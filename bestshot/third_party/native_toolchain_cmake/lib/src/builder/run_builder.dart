...
class RunCMakeBuilder {
  ...
  Future<List<String>> _generateWindowsDefines() async {
    ...
    // On Windows, leaving generator as "default" may let CMake pick NMake Makefiles,
    // which doesn't support platform specification (-A). Prefer Visual Studio generator.
    if (generator == Generator.defaultGenerator) {
      generator = Generator.vs2026;
    }

    // Generators besides Visual Studio do not support the -A argument.
    if (generator.name.startsWith("Visual Studio")) {
