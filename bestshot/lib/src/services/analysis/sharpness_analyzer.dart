...
class SharpnessAnalyzer {
  static (double, List<double>) calcLaplacianVarianceFromMat(
    ...
    try {
      ...
      for (var r = 0; r < 4; r++) {
        for (var c = 0; c < 4; c++) {
          ...
          try {
            ...
            developer.log('Error in cell calcLaplacianVarianceFromMat: $e');
            variances.add(0.0);
          } finally {
            sub?.dispose();
            lap?.dispose();
      ...
      developer.log('Error in calcLaplacianVarianceFromMat: $e\n$s');
      final targetBytes = bytes ?? getBytes?.call();
      final fb = targetBytes != null
          ? fallbackLaplacianVariance(targetBytes)
          : 0.0;
  ...
  static double fallbackLaplacianVariance(
    ...
    try {
      ...
      developer.log('Error in fallbackLaplacianVariance: $e\n$s');
      return 0;
    }
  }
}
