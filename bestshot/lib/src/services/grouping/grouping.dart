...
class PhotoGrouper {
  ...
  static void _reorderAndMarkBest(
    ...
    // Find max values in this group for normalization.
    var maxSharp = 0.01;
    for (final e in items) {
      if (e.sharpness > maxSharp) maxSharp = e.sharpness;
    }

    double score(PhotoEntry e) {
      // Normalize sharpness within this group (0..1).
      final s = (e.sharpness / maxSharp).clamp(0.0, 1.0);
