...
class PhotoTile extends StatefulWidget {
  ...
  @override
  State<PhotoTile> createState() => PhotoTileState();
}

class PhotoTileState extends State<PhotoTile> {
...
class SharpnessBadge extends StatelessWidget {
  const SharpnessBadge({super.key, required this.label, required this.color});
